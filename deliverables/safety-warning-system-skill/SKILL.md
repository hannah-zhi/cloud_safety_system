...
- 风险透视:
  ...
  - Include SOS ranking bars, risk distribution donut, SOS trend lines, SOS band chart, alarm severity donut, and module distribution chart.
  - SOS bar chart should use slim vertical bars, risk-colored thresholds, horizontal scrolling for many stations, station-number x labels, and hover tooltip with full station name plus SOS value.
  - SOS trend chart shows full-station average, maximum, and minimum with 7/15/30 day quick range buttons.
