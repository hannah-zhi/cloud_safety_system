...
- Single-station detail:
  ...
  - Subsystem SOS bar chart x-axis labels use plain numeric subsystem labels without `#`.
  ...
  - SOS 安全指数详情清单 has a sticky header. Only 子系统, 当前 SOS 指数, and 更新日期 are sortable; 风险描述 and 处置建议 are plain text headers.
