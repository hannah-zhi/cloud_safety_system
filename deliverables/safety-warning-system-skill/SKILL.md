...
- 风险透视:
  ...
  - Keep 全量场站平均 SOS as a standalone first-row panel, calculated from all valid stations and unaffected by current station filters. Do not use a standalone 高/中风险场站 KPI card.
  ...
  - Include SOS distribution bars, risk distribution donut, SOS trend point-lines, alarm severity donut, and module distribution chart.
  ...
  - SOS trend chart is a point-line chart showing full-station average, maximum, and minimum with 7/15/30 day quick range buttons and `MM-DD` x-axis labels such as `04-01`. Hovering a date column should show a vertical guide line, highlight all three points for that date, and display maximum, average, and minimum values together.
