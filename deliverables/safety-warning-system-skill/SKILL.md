...
- 风险透视:
  - The first row contains three panels: 风险场站 TOP5, 场站风险等级占比, and 全量场站平均 SOS.
  ...
  - Keep 全量场站平均 SOS as a standalone first-row panel; do not use a standalone 高/中风险场站 KPI card.
  ...
  - SOS bar chart is titled 场站SOS分布. It should use slim vertical bars, risk-colored thresholds, fixed visible horizontal scrolling for many stations, station-number x labels, and hover tooltip with full station name plus SOS value. Hovering a bar should use a translucent vertical highlight, not a white stroke box.
  - SOS trend chart is a point-line chart showing full-station average, maximum, and minimum with 7/15/30 day quick range buttons, `MM-DD` x-axis labels such as `04-01`, point hover values, and highlighted hover points.
