...
- 风险透视:
  ...
  - Keep 全量场站平均 SOS as a standalone first-row gauge panel, calculated from all valid stations and unaffected by current station filters. The gauge should use a smooth red/yellow/green gradient and should not show 当前风险等级 text. Do not use a standalone 高/中风险场站 KPI card.
  ...
  - 告警类型 TOP5 should use a progress-list layout similar to 风险场站 TOP5. Counts should vary, and colors should be red, yellow, yellow, cyan, purple in order.
